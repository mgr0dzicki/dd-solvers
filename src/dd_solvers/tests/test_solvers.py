...
@pytest.mark.parametrize(
    ...
    [
        ...
        (CG(ASM(torch.float64, Inv(), CUDSS())), torch.float64),
        (CG(ASM(torch.float32, Inv(), CUDSS())), torch.float64),
        (CG(ASM(torch.float32, Inv(), CUDSS())), torch.float32),
        (CG(ASM(torch.float32, Inv(torch.float16), CUDSS())), torch.float32),
        (CG(ASM(torch.float64, LU(), CUDSS())), torch.float64),
        (CG(ASM(torch.float32, LU(), CUDSS())), torch.float64),
        (CG(ASM(torch.float32, LU(), CUDSS())), torch.float32),
        (CG(ASM(torch.float64, Cholesky(), CUDSS())), torch.float64),
        (CG(ASM(torch.float32, Cholesky(), CUDSS())), torch.float64),
        (CG(ASM(torch.float32, Cholesky(), CUDSS())), torch.float32),
        (CG(ASM(torch.float64, BatchCUDSS(), CUDSS())), torch.float64),
        (CG(ASM(torch.float32, BatchCUDSS(), CUDSS())), torch.float64),
        (CG(ASM(torch.float32, BatchCUDSS(), CUDSS())), torch.float32),
        (CG(ASM(torch.float64, Inv(), AMGX("AGGRESSIVE_L1_TRUNC"))), torch.float64),
    ],
)
# fmt: on
