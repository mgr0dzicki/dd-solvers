...
of our PCG implementation. As usual, we measured the time required to reduce
the initial Euclidean norm of the residual by a factor of $10^9$. Our performance
metric is the \emph{throughput}, defined as the problem size (in DoFs) divided
by the total solution time. The results for $d=2$ and $p=3$ are shown in
