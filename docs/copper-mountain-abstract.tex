...
The resulting solver accepts the linear system explicitly as a sparse matrix, which
enables straightforward handling of variable or high-contrast coefficients and nonuniform meshes.
